 ...
 * @license MIT
 */ export * from "./types/oura.js";
import { API_URLS, APIError, RateLimitExceeded, ValidationError } from "./utils.js";
/**
 ...
 */ class OuraBase {
  ...
  /**
    ...
    if (response.status === 400) {
      ...
      throw new ValidationError("Query Parameter Validation Error", response.status, response.statusText, detail, baseUrl + encodeURI(url), "GET");
      ...
      throw new RateLimitExceeded("Request Rate Limit Exceeded", response.status, response.statusText, detail, baseUrl + encodeURI(url), "GET");
    } else if (response.ok) {
      ...
      throw new APIError("Problem fetching data.", response.status, response.statusText, detail, baseUrl + encodeURI(url), "GET");
    }
  };
  /**
     ...
     */ async getAll(accessToken, endpoint, initialParams) {
    const allData = [];
    let nextToken = null;
  ...
  /**
     ...
     */ fetchData(_endpoint, _params, _accessToken) {
  ...
  /**
     ...
     */ getDocuments(endpoint, startDate, endDate, accessToken) {
    const params = {
      start_date: startDate,
      end_date: endDate
    };
    return this.fetchData(endpoint, params, accessToken);
  }
  /**
     * Generic helper to fetch a single document by ID for a given endpoint.
     */ getDocumentById(endpoint, documentId, accessToken) {
    return this.fetchData(`${endpoint}/${documentId}`, undefined, accessToken);
  }
  /**
     ...
     */ getDailyActivityDocuments(startDate, endDate, accessToken) {
    return this.getDocuments("daily_activity", startDate, endDate, accessToken);
  }
  /**
     ...
     */ getDailyActivity(documentId, accessToken) {
    return this.getDocumentById("daily_activity", documentId, accessToken);
  }
  /**
     ...
     */ getDailyCardiovascularAgeDocuments(startDate, endDate, accessToken) {
    return this.getDocuments("daily_cardiovascular_age", startDate, endDate, accessToken);
  }
  /**
     ...
     */ getDailyCardiovascularAge(documentId, accessToken) {
    return this.getDocumentById("daily_cardiovascular_age", documentId, accessToken);
  }
  /**
     ...
     */ getDailyReadinessDocuments(startDate, endDate, accessToken) {
    return this.getDocuments("daily_readiness", startDate, endDate, accessToken);
  }
  /**
     ...
     */ getDailyReadiness(documentId, accessToken) {
    return this.getDocumentById("daily_readiness", documentId, accessToken);
  }
  /**
     ...
     */ getDailyResilienceDocuments(startDate, endDate, accessToken) {
    return this.getDocuments("daily_resilience", startDate, endDate, accessToken);
  }
  /**
     ...
     */ getDailyResilience(documentId, accessToken) {
    return this.getDocumentById("daily_resilience", documentId, accessToken);
  }
  /**
     ...
     */ getDailySleepDocuments(startDate, endDate, accessToken) {
    return this.getDocuments("daily_sleep", startDate, endDate, accessToken);
  }
  /**
     ...
     */ getDailySleep(documentId, accessToken) {
    return this.getDocumentById("daily_sleep", documentId, accessToken);
  }
  /**
     ...
     */ getDailySpo2Documents(startDate, endDate, accessToken) {
    return this.getDocuments("daily_spo2", startDate, endDate, accessToken);
  }
  /**
     ...
     */ getDailySpo2(documentId, accessToken) {
    return this.getDocumentById("daily_spo2", documentId, accessToken);
  }
  /**
     ...
     */ getDailyStressDocuments(startDate, endDate, accessToken) {
    return this.getDocuments("daily_stress", startDate, endDate, accessToken);
  }
  /**
     ...
     */ getDailyStress(documentId, accessToken) {
    return this.getDocumentById("daily_stress", documentId, accessToken);
  }
  /**
     ...
     */ getHeartrate(startDateTime, endDateTime, accessToken) {
    const params = {
      start_datetime: startDateTime,
      end_datetime: endDateTime
    };
    return this.fetchData("heartrate", params, accessToken);
  }
  /**
    ...
    return this.fetchData("personal_info", undefined, accessToken);
  }
  /**
     ...
     */ getRestModePeriodDocuments(startDate, endDate, accessToken) {
    return this.getDocuments("rest_mode_period", startDate, endDate, accessToken);
  }
  /**
     ...
     */ getRestModePeriod(documentId, accessToken) {
    return this.getDocumentById("rest_mode_period", documentId, accessToken);
  }
  /**
     ...
     */ getRingConfigurationDocuments(startDate, endDate, accessToken) {
    return this.getDocuments("ring_configuration", startDate, endDate, accessToken);
  }
  /**
     ...
     */ getRingConfiguration(documentId, accessToken) {
    return this.getDocumentById("ring_configuration", documentId, accessToken);
  }
  /**
     ...
     */ getDailySessionDocuments(startDate, endDate, accessToken) {
    return this.getDocuments("session", startDate, endDate, accessToken);
  }
  /**
     ...
     */ getDailySession(documentId, accessToken) {
    return this.getDocumentById("session", documentId, accessToken);
  }
  /**
     ...
     */ getSleepDocuments(startDate, endDate, accessToken) {
    return this.getDocuments("sleep", startDate, endDate, accessToken);
  }
  /**
     ...
     */ getSleep(documentId, accessToken) {
    return this.getDocumentById("sleep", documentId, accessToken);
  }
  /**
     ...
     */ getSleepTimeDocuments(startDate, endDate, accessToken) {
    return this.getDocuments("sleep_time", startDate, endDate, accessToken);
  }
  /**
     ...
     */ getSleepTime(documentId, accessToken) {
    return this.getDocumentById("sleep_time", documentId, accessToken);
  }
  /**
     ...
     */ getTagDocuments(startDate, endDate, accessToken) {
    console.log("Tag is deprecated. We recommend transitioning to Enhanced Tag.");
    return this.getDocuments("tag", startDate, endDate, accessToken);
  }
  /**
     ...
     */ getTag(documentId, accessToken) {
    console.log("Tag is deprecated. We recommend transitioning to Enhanced Tag.");
    return this.getDocumentById("tag", documentId, accessToken);
  }
  /**
     ...
     */ getVO2MaxDocuments(startDate, endDate, accessToken) {
    return this.getDocuments("vO2_max", startDate, endDate, accessToken);
  }
  /**
     ...
     */ getVO2Max(documentId, accessToken) {
    return this.getDocumentById("vO2_max", documentId, accessToken);
  }
  /**
     ...
     */ getWorkoutDocuments(startDate, endDate, accessToken) {
    return this.getDocuments("workout", startDate, endDate, accessToken);
  }
  /**
     ...
     */ getWorkout(documentId, accessToken) {
    return this.getDocumentById("workout", documentId, accessToken);
  }
  /**
     ...
     */ getEnhancedTagDocuments(startDate, endDate, accessToken) {
    return this.getDocuments("enhanced_tag", startDate, endDate, accessToken);
  }
  /**
     ...
     */ getEnhancedTag(documentId, accessToken) {
    return this.getDocumentById("enhanced_tag", documentId, accessToken);
  }
}
export default OuraBase;
//# sourceMappingURL=OuraBase.js.map