...
import { generateAuthUrl, getTokens, refreshToken, revokeToken } from "./utilsOAuth.js";
import { MissingClientIdError, MissingClientSecretError, MissingRedirectUriError, MissingTokenError } from "./utils.js";
/**
 ...
 */ class OuraOAuth extends OuraBase {
  ...
  /**
     ...
     */ fetchData(endpoint, params, accessToken) {
    if (!accessToken) {
  ...
  /**
    ...
    const tokenData = await getTokens(this.#clientId, this.#clientSecret, code, this.#redirectUri);
    return tokenData;
  }
  /**
     ...
     */ async refreshAccessToken(suppliedRefreshToken) {
    const tokenData = await refreshToken(this.#clientId, this.#clientSecret, suppliedRefreshToken);
    return tokenData;
  }
  /**
...
//# sourceMappingURL=OuraOAuth.js.map