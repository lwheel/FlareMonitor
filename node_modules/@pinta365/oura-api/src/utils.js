 ...
 */ export const API_URLS = {
  /** Default api endpoint url */ baseV2: "https://api.ouraring.com/v2/usercollection/",
  /** Used when requesting sandbox endpoints */ basev2Sandbox: "https://api.ouraring.com/v2/sandbox/usercollection/",
  oauth: {
 ...
 */ export class APIError extends Error {
  ...
  url;
  method;
  constructor(message, statusCode, responseBody, detail, url, method){
    super(message);
    this.name = "APIError";
 ...
 */ export class ValidationError extends APIError {
  /**
     ...
     */ constructor(message, statusCode, statusText, detail, url, method){
